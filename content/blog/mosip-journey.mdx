...
Imagine this scenario: A new employee joins a company.

1. HR verifies the employee's documents and approves them
2. The employee receives an email with a QR code
3. They scan it with their digital wallet
4. They receive an SMS with a transaction code for verification
5. They enter the code, and boom—their employee credential is automatically issued

No complex authentication flows, no manual intervention. Just smooth, automated credential issuance.
